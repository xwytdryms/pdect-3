<div class=" col-start-4 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg" id="widget" style="height: auto; width: 13.5rem;">
    <div class="p-4 bg-white  text-left rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <a href="{{ route('devicemanager') }}" class="inline-flex font-medium items-center text-blue-600 hover:underline">
            Add Device
            <svg class="w-[20px] h-[20px] ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
