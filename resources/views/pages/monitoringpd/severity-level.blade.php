<div class="col-start-3 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg" id="widget" style="height: 10rem; width: 12rem;">
    <div class="p-4 bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex bg-blue-400 justify-center justify-item-center overflow-hidden" style="width: auto height: auto">
        ...
        <p class="py-3 bg-green-300 mt-1 font-normal text-sm text-gray-500 dark:text-gray-400">Last updated 2 hours ago  
        </p>
    </div>
</div>